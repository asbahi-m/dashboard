$('document').ready(function(){
    ...
    ///////////////////////////////////////// إحصائيات عدد المشاركات
    $("#chart-posts").insertFusionCharts({
        type: "column2d",
        width: "100%",
        height: "100%",
        dataFormat: "json",
        dataSource: {
            ...
            "chart": {
                "theme": "fusion",
                "caption": "عدد مشاركات الموقع إجمالاً",
                "subCaption": "إحصائيات تفصيلية بحسب أنواع المشاركات",
                "xAxisName": "أنواع المحتوى",
    ...
    $("#chart-userPosts").insertFusionCharts({
        ...
        dataSource: {
            ...
            "chart": {
                "theme": "fusion",
                "caption": "عدد مشاركات المستخدمين",
                "subCaption": "إحصائيات تفصيلية بعدد المشاركات لكل مستخدم",
                "xAxisName": "المستخدمين",
                "yAxisName": "عدد المشاركات",
                "numberPrefix": "",
                "numberSuffix": "",
                "exportEnabled": "1",
